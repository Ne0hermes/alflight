...
const FIELD_MAPPINGS = [
  ...
  { aircraftPath: 'speeds.vx',           src: ['speeds', 'vx'],           category: 'speed', targetUnit: 'kt', label: 'VX',      description: 'Vitesse de meilleur angle de montée (gain altitude maximal par unité de distance horizontale parcourue). Utile pour franchir un obstacle. Indiquée en configuration takeoff.' },
  { aircraftPath: 'speeds.vy',           src: ['speeds', 'vy'],           category: 'speed', targetUnit: 'kt', label: 'VY',      description: 'Vitesse de meilleur taux de montée (gain altitude maximal par unité de temps). Utilisée en montée standard. Indiquée en configuration takeoff.' },
